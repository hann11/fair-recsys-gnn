...
def parse_args():
    ...
    parser.add_argument(
        "--weights_path", nargs="?", default="", help="Store model path."
    )
    parser.add_argument(
        "--data_path", nargs="?", default="../Data/", help="Input data path."
    )
    parser.add_argument(
        "--proj_path", nargs="?", default="", help="Project path."
    )
    ...
    parser.add_argument(
        "--epoch", type=int, default=100, help="Number of epoch."
    )

    parser.add_argument(
        "--embed_size", type=int, default=64, help="CF Embedding size."
    )
    parser.add_argument(
        "--kge_size", type=int, default=64, help="KG Embedding size."
    )
    parser.add_argument(
        "--layer_size",
        nargs="?",
    ...
    parser.add_argument(
        "--batch_size", type=int, default=1024, help="CF batch size."
    )
    parser.add_argument(
